...
public class chatwindo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDeleteAll = findViewById(R.id.btnDeleteAll); // 🔹 find delete button
        ...
        btnDeleteAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(chatwindo.this)
                                    ...
                                    .addOnSuccessListener(aVoid -> {
                                        database.getReference().child("chats").child(reciverRoom).child("messages")
                                                ...
                                                .addOnSuccessListener(aVoid2 ->
                                                        Toast.makeText(chatwindo.this, "All messages deleted", Toast.LENGTH_SHORT).show()
                                                );
                                    });
                        })
